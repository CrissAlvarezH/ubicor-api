...
from app.auth.scopes import CREATE_UNIVERSITIES, DELETE_UNIVERSITIES, EDIT_UNIVERSITIES, EDIT_USERS, LIST_USERS
from app.db.dependencies import get_db
from app.auth.dependencies import Auth

from app.universities.crud.university import create_university, create_university_ownership, delete_all_assigned_university, get_assigned_universities, is_owner, \
    list_universities, list_universities_by_slugs, update_university, delete_university
